...
type UnlikeReviewController struct {
	useCase *application.UnlikeReviewUseCase
}

func NewUnlikeReviewController(useCase *application.UnlikeReviewUseCase) *UnlikeReviewController {
	return &UnlikeReviewController{useCase: useCase}
}

func (c *UnlikeReviewController) Handle(w http.ResponseWriter, r *http.Request) {
