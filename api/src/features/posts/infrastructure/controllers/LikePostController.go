...
type LikePostController struct {
	useCase *application.LikePostUseCase
}

func NewLikePostController(useCase *application.LikePostUseCase) *LikePostController {
	return &LikePostController{useCase: useCase}
}

func (c *LikePostController) Handle(w http.ResponseWriter, r *http.Request) {
