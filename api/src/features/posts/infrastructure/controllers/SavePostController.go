...
type SavePostController struct {
	useCase *application.SavePostUseCase
}

func NewSavePostController(useCase *application.SavePostUseCase) *SavePostController {
	return &SavePostController{useCase: useCase}
}

func (c *SavePostController) Handle(w http.ResponseWriter, r *http.Request) {
