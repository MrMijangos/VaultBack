...
type DeleteChatMessageController struct {
	useCase *application.DeleteChatMessageUseCase
}

func NewDeleteChatMessageController(useCase *application.DeleteChatMessageUseCase) *DeleteChatMessageController {
	return &DeleteChatMessageController{useCase: useCase}
}

func (c *DeleteChatMessageController) Handle(w http.ResponseWriter, r *http.Request) {
