...
type DeleteNotificationController struct {
	useCase *application.DeleteNotificationUseCase
}

func NewDeleteNotificationController(useCase *application.DeleteNotificationUseCase) *DeleteNotificationController {
	return &DeleteNotificationController{useCase: useCase}
}

func (c *DeleteNotificationController) Handle(w http.ResponseWriter, r *http.Request) {
