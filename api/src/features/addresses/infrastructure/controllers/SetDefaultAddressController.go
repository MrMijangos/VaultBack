...
type SetDefaultAddressController struct {
	useCase *application.SetDefaultAddressUseCase
}

func NewSetDefaultAddressController(useCase *application.SetDefaultAddressUseCase) *SetDefaultAddressController {
	return &SetDefaultAddressController{useCase: useCase}
}

func (c *SetDefaultAddressController) Handle(w http.ResponseWriter, r *http.Request) {
