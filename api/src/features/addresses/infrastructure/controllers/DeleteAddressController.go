...
type DeleteAddressController struct {
	useCase *application.DeleteAddressUseCase
}

func NewDeleteAddressController(useCase *application.DeleteAddressUseCase) *DeleteAddressController {
	return &DeleteAddressController{useCase: useCase}
}
