...
type DeleteCommentController struct {
	useCase *application.DeleteCommentUseCase
}

func NewDeleteCommentController(useCase *application.DeleteCommentUseCase) *DeleteCommentController {
	return &DeleteCommentController{useCase: useCase}
}

func (c *DeleteCommentController) Handle(w http.ResponseWriter, r *http.Request) {
